 ...
 * Я осознаю что на этом функционале можно запустить вообще все приложение если тут доработать кое что и не придумывать observerRender.
 * Но в задании хотели увидеть не VirtualDom а Emojis, так что все силы были брошены на Emoji.
*/
type AttsType = {
